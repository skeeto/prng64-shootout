...
#define BJSMALL64_SETUP() \
    uint64_t s[4]; \
    bjsmall64_init(s, 0xdeadbeefcafebabe)
#define BJSMALL64_RAND(dst) \
    dst = bjsmall64(s)
...
DEFINE_BENCH(bjsmall64, BJSMALL64_SETUP, BJSMALL64_RAND);
...
main(int argc, char **argv)
{
    static const struct {
        ...
        {bjsmall64_bench,        bjsmall64_pump,        "bjsmall64"},
    };
