...
rrmxmx(uint64_t *s)
{
    uint64_t v = (*s += UINT64_C(0x45b655ba41059491));
    v ^= (v << 15 | v >> 49) ^ (v << 40 | v >> 24);
...
DEFINE_BENCH(rrmxmx, RRMXMX_SETUP, RRMXMX_RAND);
...
main(int argc, char **argv)
{
    static const struct {
        ...
        {rrmxmx_bench,           rrmxmx_pump,           "rrmxmx"},
    };
